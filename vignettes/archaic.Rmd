...
```{r}
out2 <- prepare_archaic(dirs = c(moderns_dir, ancients_dir))
out3 <- prepare_archaic(dirs = moderns_dir)
```
...
```{r}
model <- model_archaic(c(moderns_dir, ancients_dir), K = 2, output_dir = output_dir) 
```
