...
```{r}
list.files(system.file("extdata","moderns", package = "aRchaic"), pattern = ".csv")
```

- Ancient files :

```{r}
list.files(system.file("extdata","ancients", package = "aRchaic"), pattern = ".csv")
```
...
out <- prepare_archaic(dirs = c(paste0(system.file("extdata","moderns", package = "aRchaic"), "/"), 
                                paste0(system.file("extdata","ancients/", package = "aRchaic"), "/")))
```
...
```{r}
out2 <- prepare_archaic(dirs = c(paste0(system.file("extdata","moderns", package = "aRchaic"), "/"), 
                                paste0(system.file("extdata","ancients/", package = "aRchaic"), "/")))
out3 <- prepare_archaic(dirs = paste0(system.file("extdata","moderns", package = "aRchaic"), "/"))
```
...
We fit the mixed membership model in **aRchaic** onthe output from `prepare_archaic()`.
...
```{r}
model <- model_archaic(c(paste0(system.file("extdata","moderns", package = "aRchaic"), "/"), 
                                paste0(system.file("extdata","ancients/", package = "aRchaic"), "/")), K = 2,
                       output_dir = paste0(system.file("extdata","archaic_results", package = "aRchaic"), "/")) 
```
...
```{r warning = FALSE, message = FALSE}
plot_archaic(model, output_dir = paste0(system.file("extdata","archaic_results", package = "aRchaic"), "/"), background = "modern")
```
