...
**aRchaic** has been developed by [Kushal K. Dey](kkdey.github.io) and 
[Hussein Al-Asadi](https://halasadi.wordpress.com/) from the 
University of Chicago.

To cite **aRchaic**, cite the following paper

## Acknowledgements

The authors acknowledge John Lindo, John Blischak, Peter Carbonetto, Anna Di Rienzo,
Anna Gosling, David Witonsky and Choonwong Jeong for helpful discussions about the 
package.
