#' @title Classification (model-based and non-model based) of aDNA samples using DNA damage patterns
#'
#' @description Performs classification of aDNA samples using DNA damage patterns- mutation,
