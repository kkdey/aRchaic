...
#' (folders).
#'
#' @description Aggregate signature counts data using process_archaic() from
#' multiple study directories into a single data frame or matrix.
#'
#' @param dat may be a list of count data matrices generated by prepare_archaic()
...
#'
#'
#' @keywords pool_archaic
#' @export



pool_archaic = function(dat){

  message("Checking if the folders exist")

  if(class(dat) == "list"){

############################   when dat is a list generated by prepare_archaic  ##############################
 ...
 ##############   when dat is a vector of folder names generated by prepare_archaic  ##############################
