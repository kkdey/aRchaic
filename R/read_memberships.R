...
#' BAM file.
#'
#' @param object a Grade of Membership model saved under \code{model.rda} produced
#' as output by \code{aRchaic_cluster()} function.
#'
#' @param new_counts The new counts matrix of signature patterns for each read
#' in the BAM file.
#'
...
read_memberships = function (fit, reads_data, method = "independent",
