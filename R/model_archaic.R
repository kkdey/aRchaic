...
#'                   
#' @return Fits the GoM model on the aggregated data from \code{process_archaic}
...
model_aRchaic <- function(dirs,
  ...
  ll <- list("gom_model" = topic_clus,
             "gom_assess" = model_assessment)
  return(ll)
}
