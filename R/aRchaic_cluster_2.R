...
aRchaic_cluster_2 = function(folders,
                           K,
                           tol=100,
                           labs = NULL,
                           levels = NULL,
  ...
  logo.control.default <- list(sig_names = NULL,
                               ...
                               break_ranges = c(0,0),
                               logoport_x = 0.7,
                               logoport_y= 0.5, logoport_width= 1, logoport_height= 1.2,
                               breaklogoport_x = 0.5, breaklogoport_y = 0.4, breaklogoport_width=0.7,
                               breaklogoport_height=1, lineport_x = 0.7, lineport_y=0.5,
