...
#'
#' @description Breaking down a theta matrix into component probabilities for strand break 
#'          composition (probability it is A, C, G or T),
...
#'         mutation, flanking base, distance from end of read and strand break composition
#'         separately.
...
theta_breakdown = function (theta_pool, flanking_bases = 1, max_pos = 20) {
  ...
  theta <- dplyr::tbl_df(data.frame(theta_pool)) %>% 
